...
data <- tibble(x = c(1, 2, 3, 4, 5), y = c(-0.5, 1, 2, 4, 7))
...
ggplot(data, aes(x = x, y = y)) +
  ...
  geom_segment(aes(x = x, y = y, xend = x, yend = y_hat), color = "red", linetype = "dashed") +
...
ggplot() +
  ...
  xlab("Difference between y and y_hat") +
  ylab("Loss (squared error)")
```
