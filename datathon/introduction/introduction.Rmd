...
* Equip clinicians with the ability to translate their research questions and hypotheses into data science language, introduce them to tools like Machine Learning, R, R Markdown, and RStudio.
...
```{r}
data <- read.csv("../mimic_pulseOx_data.csv")
```
